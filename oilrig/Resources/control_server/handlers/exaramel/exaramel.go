...
// Represents the Exaramel C2 handler. Will implement the util.Handler interface.
type ExaramelHandler struct {}

// Creates and adds the ExaramelHandler to the map of available C2 handlers.
func init() {
	util.AvailableHandlers["exaramel"] = &ExaramelHandler{}
}
...
func (e *ExaramelHandler) StartHandler(restAddress string, configEntry config.HandlerConfigEntry) error {
...
func (e *ExaramelHandler) StopHandler() error {
