...
// Represents the Emotet C2 handler. Will implement the util.Handler interface.
type EmotetHandler struct {}

// Creates and adds the EmotetHandler to the map of available C2 handlers.
func init() {
	util.AvailableHandlers["emotet"] = &EmotetHandler{}
}
...
func (e *EmotetHandler) StartHandler(restAddress string, configEntry config.HandlerConfigEntry) error {
...
// Stops the Emotet handler
func (e *EmotetHandler) StopHandler() error {
	logger.Info("Killing Emotet Server")
