...
func startHTTPSHandler() {
	https.StartHandler(listenHost, restAPIlistenHost, certFile, keyFile)
	time.Sleep(50 * time.Millisecond)
}

func stopHTTPSHandler() {
	https.StopHandler()
	time.Sleep(50 * time.Millisecond)
}
